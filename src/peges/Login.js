        ...
        <div className='inin'>
          <form action="" >
            ...
            <div className='inpusbox'><i class="bi bi-envelope-at-fill">
              <svg xmlns="http://www.w3.org/2000/svg" style={{ color: "white", marginRight: "10px" }} width="20" height="20" fill="currentColor" class="bi bi-envelope-at-fill" viewBox="0 0 16 16">
            ...
            <div className='inpusbox'>
              <i class="bi bi-lock-fill">
                <svg xmlns="http://www.w3.org/2000/svg" style={{ color: "white", marginRight: "10px" }} width="20" height="20" fill="currentColor" class="bi bi-lock-fill" viewBox="0 0 16 16">
