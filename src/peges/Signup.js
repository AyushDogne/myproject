            ...
            <div className='input'>
              ...
              <div style={{display:"flex", justifyContent:"space-around"}}>
                <div> <i class="bi bi-person-circle" style={{ paddingRight: "5px" }}>
                  ...
                  <input type="text" placeholder='Enetr user name' className='inputs' required /></div><br />
                ...
                <div> <i class="bi bi-person-lines-fill" style={{ paddingRight: "5px", color: "white" }}>
                  ...
                  <input type="number" placeholder='Enetr user number' className='inputs' required /></div></div><br/>
                ...
                <div><i class="bi bi-envelope-at-fill" style={{ paddingRight: "5px", color: "white" }}>
                  ...
                  <input type="email" placeholder='Enetr user e-mail' className='inputs' required /></div><br />
                ...
                <div> <i class="bi bi-lock-fill" style={{ paddingRight: "5px", color: "white" }}>
                  ...
                  <input type="password" placeholder='Enetr user password' className='inputs' required /></div> </div><br />
                ...
                <div><i class="bi bi-gender-female" style={{ paddingRight: "5px", color: "white" }}>
                  ...
                  <input type="text" placeholder='Enetr user Gender' className='inputs' required /></div><br />
                <div><i class="bi bi-buildings-fill" style={{ paddingRight: "5px", color: "white" }}>
                  ...
                  <input type="text" placeholder='Enetr user city' className='inputs' required /></div> </div><br />
                ...
                <div><i class="bi bi-file-earmark-code-fill" style={{ paddingRight: "5px", color: "white" }}>
                  ...
                  <input type="text" placeholder='Enetr user pine code' className='inputs' required /></div><br />
                <div><i class="bi bi-device-ssd-fill" style={{ paddingRight: "5px", color: "white" }}>
                  ...
                  <input type="text" placeholder='Enetr user state' className='inputs' required /></div> </div><br />
                <div><i class="bi bi-geo-alt-fill" style={{ paddingRight: "5px", color: "white" }}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                    <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6" />
                  </svg>
                </i>
                  <input type="text" placeholder='Enetr user location' className='inputs' style={{marginRight:"260px"}} required /></div><br />
