    ...
    <div className='main-display'>
      <div>
        <div className='summery-cart-1'>
          ...
          <div><p className='summery-image'></p>
          ...
          <div style={{ paddingTop: "10px", paddingLeft: "7px" }}><h6>Zebronics Zeb-Action Portable 10W BT Speaker with TWS Function,
            USB,mSD, AUX, FM, Mic & Fabric Finish(Red)</h6>
