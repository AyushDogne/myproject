...
const Summery = () => {
  ...
  return (
    <div className='main-summery-div'>
    ...
    <div className='main-display'>
      ...
      <div>
        <div className='summery-cart-1'>
          ...
          <div>  
            <img src={require("../" + location.state.from.image)} className='summery-image'/>
          </div>

          <div className='summery-image-border'></div>

        <div>
          <div style={{ paddingTop: "20px", paddingLeft: "7px" }}><h6>{location.state.from.title}</h6>

          
           <div className='summery-title'>
             <div className='summery-bordar-to'> All issue easy returns allowed</div>
             <div className='summery-bordar-to'>|</div>
             <div className='summery-bordar-to'> Size: Free Size  Qty: 1</div>
           </div>
         ...
         <div className='case-payment'>
          <h5 style={{color:"black"}}>{location.state.from.delivery}</h5>
         </div>
